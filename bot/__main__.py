...
def start(update, context):
    ...
    buttons.buildbutton("ҒᏆᏞͲᎬᎡ ᏴϴͲ", "not available")
    buttons.buildbutton("ᎷϴᏙᏆᎬ ᏀᎡϴႮᏢ", "https://t.me/ssrrmirror")
    buttons.buildbutton("ᎷᏆᎡᎡϴᎡ ᏀᎡϴႮᏢ", "https://t.me/ssrrmirror")
    buttons.buildbutton("ᎠᎬᏙᎬᏞϴᏢᎬᎡ", "https://t.me/Yesbror")
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='seriesflix 𝙷𝙴𝙻𝙿',
        author_name='series-MIRROR',
